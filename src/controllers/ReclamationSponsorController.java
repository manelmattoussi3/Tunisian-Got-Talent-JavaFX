 ...
 */
public class ReclamationSponsorController implements Initializable 
{
     @FXML
    ...
    public ReclamationSponsorController()
    {
    ...
    {  
     ...
     public ObservableList<Reclamation> fetRowList() 
     {
        ...
        try {
          ...
          int id_user =  Recherche(nomutlisateur.getText()).getId();
          int id_userReclamation  = Integer.parseInt(chaine[6]);
           
                  if (id_user==id_userReclamation)
    ...
    private void Handle5Events(MouseEvent event) {
        //check if not empty
              ...
              try {
                   FXMLLoader loader =  new  FXMLLoader(getClass().getResource("/fxml/AccueilFXML.fxml")); 

                    Parent root = (Parent) loader.load();
                    AccueilFXMLController utcontroller = loader.getController(); 
